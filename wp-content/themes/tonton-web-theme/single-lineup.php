...
get_header();
?>
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/css/pages/estate.css" media="screen" >
...
<main id="primary" class="site-main">
  <div class="estate-contents">
    ...
    <div class="wrapper">
      ...
      <div class="estate-block estate-block--top">
        <div class="estate-detail">
          <div class="estate-detailMain">
            <div class="estate-tableArea">
              ...
              <div class="estate-button estate-button--green">
                <div class="estate-buttonInner estate-buttonInner--small">
                  <a href="/contact">
                    お問い合わせ
                  </a>
                  <div class="estate-buttonArrow">
          ...
          <div>
            <h3 class="estate-subTitle">物件情報</h3>
            <div class="estate-points">
              <span class="estate-pointLabel">Point</span>
              <div class="estate-pointArea">
            ...
            <div class="estate-detailAll">
              ...
              <!-- TODO: 新規で作成？ -->
              <ul class="estate-plan">
                <li>
                  <h3 class="estate-planTitle">実施したリフォームプラン</h3>
                  <div class="estate-planBlock">
                    <div>
                      <img src="https://placehold.jp/492x276.png" alt="">
                    </div>
                    <div>
                      <h4 class="estate-planSubTitle">プラン名が入りますプラン名が入ります</h4>
                      <div>
                ...
                <li>
                  <h3 class="estate-planTitle">実施したリノベーションプラン</h3>
                  <div class="estate-planBlock">
                    <div>
                      <img src="https://placehold.jp/492x276.png" alt="">
                    </div>
                ...
                <li>
                  <h3 class="estate-planTitle">おすすめのプラン</h3>
                  <div class="estate-planBlock">
                    <div>
                      <img src="https://placehold.jp/492x276.png" alt="">
                    </div>
